...
A number of relevant system properties are listed in xref:src/main/docs/system-properties.adoc[System Properties].
For safety and ownership guidance, see xref:src/main/docs/security-review.adoc[Security Review] and xref:src/main/docs/memory-management.adoc[Memory Management].
The xref:src/main/docs/testing-strategy.adoc#evidence-status[evidence table] distinguishes tested contracts from requirements and performance targets.
