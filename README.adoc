...
image:https://maven-badges.herokuapp.com/maven-central/>net.openhft/chronicle-bytes/badge.svg["Maven Central",link="https://maven-badges.herokuapp.com/maven-central/>net.openhft/chronicle-bytes/asciidoctor-maven-plugin"]
endif::[]
