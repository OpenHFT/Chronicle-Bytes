...
[![Quality Gate Status](https://sonarqube.chronicle.software/api/project_badges/measure?project=net.openhft%3Achronicle-bytes&metric=alert_status)](https://sonarqube.chronicle.software/dashboard?id=net.openhft%3Achronicle-bytes)
endif::[]
