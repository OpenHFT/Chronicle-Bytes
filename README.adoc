...
image::docs/images/Bytes_line.png[width=20%]
...
For detailed requirements and design rationale, see link:src/main/docs/project-requirements.adoc[project-requirements.adoc].
