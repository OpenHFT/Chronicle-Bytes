...
Follow the root `AGENTS.md` and `canonical-AGENTS.md` for base rules; this file adds Chronicle-Bytes specifics. Durable docs live in `src/main/docs/` with the landing page at `README.adoc`.
