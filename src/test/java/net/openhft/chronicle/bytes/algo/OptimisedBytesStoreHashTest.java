...
public class OptimisedBytesStoreHashTest extends BytesTestCommon {
    ...
    public void testApplyAsLong() {
        ...
        assertEquals(VanillaBytesStoreHash.INSTANCE.applyAsLong(b), OptimisedBytesStoreHash.INSTANCE.applyAsLong(b),
                "testApplyAsLong: assertEquals");
...
/*               if (true) {
        ...
        System.out.printf("Average time %.3f us%n", (double) time / (double) timeCount / 1e3);
        assertTrue(timeCount > 0, "testSmallRandomness: timeCount > 0");
        assertTrue(scoreSum > 0, "testSmallRandomness: scoreSum > 0");
    }
