...
public class AbstractBytesTest {
    ...
    public void appendAndReturnLengthCallsBytesStore() {
        ...
        assertEquals(expectedLength, length, "appendAndReturnLength should delegate to BytesStore and return its value");
    ...
    public void readPositionForHeaderWithSkipPadding() {
        ...
        assertEquals(0, newPosition, "readPositionForHeader with skipPadding should return 0");
    }
    ...
    public void toStringReturnsExpectedString() {
        ...
        assertNotNull(result, "toString() should return non-null string");
        assertFalse(result.contains("MockBytesStore"), "result.contains");
    }
    ...
    public void byteCheckSumCalculatesCorrectSum() {
        ...
        assertEquals(10, sum, "byteCheckSum should sum 10 bytes each with value 1");
    }
}
