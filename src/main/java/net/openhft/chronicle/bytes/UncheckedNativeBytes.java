...
public class UncheckedNativeBytes<U>
    ...
    @NotNull
    protected NativeBytesStore<U> bytesStore;
    ...
    public UncheckedNativeBytes(@NotNull Bytes<U> underlyingBytes)
        ...
        this.bytesStore = (NativeBytesStore<U>) underlyingBytes.bytesStore();
    ...
    public void ensureCapacity(long desiredCapacity)
        ...
        if (desiredCapacity > realCapacity()) {
            ...
            bytesStore = (NativeBytesStore<U>) underlyingBytes.bytesStore();
        }
    }
...
//        assert writeCheckOffset0(offset, adding);
    ...
    public int byteCheckSum()
        ...
        final NativeBytesStore bs = (NativeBytesStore) bytesStore();
        return bs.byteCheckSum(readPosition(), readLimit());
    }
    ...
    @Override
    public @NotNull Bytes<U> write8bit(@NotNull String s, int start, int length) {
