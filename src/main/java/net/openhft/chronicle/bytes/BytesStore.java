...
public interface BytesStore<B extends BytesStore<B, U>, U>
    ...
    */
    ...
    //! MappedBytesReadAcrossMappingTest#hashAcrossTheMappingEndIsRejected pins the native single-mapping contract.
    /**
     ...
     * @throws UnsupportedOperationException If a native hash range is outside the current store, including any mapping overlap.
     * @throws ClosedIllegalStateException    If the resource has been released or closed.
     * @throws ThreadingIllegalStateException If this resource was accessed by multiple threads in an unsafe way.
     */
