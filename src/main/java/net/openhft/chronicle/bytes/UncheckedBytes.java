...
public class UncheckedBytes<U>
    ...
    public UncheckedBytes(@NotNull Bytes underlyingBytes)
        ...
        super((AbstractBytesStore<Bytes<U>, U>) underlyingBytes.bytesStore(), underlyingBytes.writePosition(), underlyingBytes.writeLimit());
    ...
    public void setBytes(@NotNull Bytes bytes)
        ...
        if (bytesStore != bs) {
            ...
            this.bytesStore((AbstractBytesStore<Bytes<U>, U>) bs);
    ...
    public void ensureCapacity(long desiredCapacity)
        ...
        if (desiredCapacity > realCapacity()) {
            ...
            bytesStore((AbstractBytesStore<Bytes<U>, U>) underlyingBytes.bytesStore());
        }
    }
