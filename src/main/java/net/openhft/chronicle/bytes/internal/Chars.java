...
public final class Chars {
    ...
    private static final String[] CHAR_LOOKUP = createCharToString();
     ...
     */
    @NotNull
    private static String[] createCharToString() {
    ...
    /**
     * Returns the printable representation for the supplied byte value.
     */
    public static String charToString(int value) {
        return CHAR_LOOKUP[value & 0xFF];
    }
}
