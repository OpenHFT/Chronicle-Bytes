...
== 1  Scope
Chronicle Bytes is the low-level memory-access layer for the wider OpenHFT
stack.
These requirements define the contracts, performance envelopes and
operational obligations that the library **must** meet to be accepted into the
Chronicle Software code-base.
