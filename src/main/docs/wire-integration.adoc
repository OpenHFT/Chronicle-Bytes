...
`Chronicle Bytes` instances xref:project-requirements.adoc#CB-FN-008[CB-FN-008].
...
Performance example for serializing/deserializing a simple 6-field object (xref:project-requirements.adoc#CB-NF-P-001[CB-NF-P-001] baseline, 3.2 GHz x86-64):
