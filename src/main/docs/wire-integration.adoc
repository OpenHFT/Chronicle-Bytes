...
* YAML: ~0.25 - 0.45 micros mean (depending on complexity)
* JSON: ~0.20 - 0.35 micros mean
* TEXT: ~0.18 - 0.30 micros mean
* BINARY_LIGHT: ~0.15 - 0.25 micros mean
* RAW: ~0.10 - 0.20 micros mean
